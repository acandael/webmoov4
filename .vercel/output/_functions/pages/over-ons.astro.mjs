...
}, "/Users/anthonycandaele/Projects/webmoov4/website/src/components/Process.astro", void 0);

const aboutUsImage = new Proxy({"src":"/_astro/about-us.CRpxdLdP.jpg","width":1172,"height":1171,"format":"jpg"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/Users/anthonycandaele/Projects/webmoov4/website/src/assets/about-us.jpg";
							}
...
const $$OverOns = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Over Ons | Web Design & Development Bureau | Webmoov", "description": "Webmoov is een web design en development bureau gespecialiseerd in maatwerk websites. Ons team van experts cre\xEBert digitale ervaringen die impact maken voor uw bedrijf. 150+ succesvolle projecten en 98% klanttevredenheid.", "data-astro-cid-hf4sd4qg": true }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<section class="section" data-astro-cid-hf4sd4qg> <div class="container" data-astro-cid-hf4sd4qg> <div class="content" data-astro-cid-hf4sd4qg> <h1 class="section-title" data-astro-cid-hf4sd4qg>Over Webmoov - Web Design & Development Bureau</h1> <p class="subtitle" data-astro-cid-hf4sd4qg>
Een team van gepassioneerde experts gespecialiseerd in maatwerk websites en digitale oplossingen die impact maken voor uw bedrijf.
</p> <div class="stats" data-astro-cid-hf4sd4qg> <div class="stats-item" data-astro-cid-hf4sd4qg> <p class="number" data-astro-cid-hf4sd4qg>150+</p> <p data-astro-cid-hf4sd4qg>Succesvolle projecten</p> </div> <div class="stats-item" data-astro-cid-hf4sd4qg> <p class="number" data-astro-cid-hf4sd4qg>98%</p> <p data-astro-cid-hf4sd4qg>Klanttevredenheid</p> </div> <div class="stats-item" data-astro-cid-hf4sd4qg> <p class="number" data-astro-cid-hf4sd4qg>24/7</p> <p data-astro-cid-hf4sd4qg>Support beschikbaar</p> </div> </div> </div> <div class="image" data-astro-cid-hf4sd4qg> ${renderComponent($$result2, "Image", $$Image, { "src": aboutUsImage, "alt": "Wij zijn Webmoov", "width": 800, "height": 600, "class": "box-shadow", "format": "webp", "quality": "high", "data-astro-cid-hf4sd4qg": true })} </div> </div> </section> ${renderComponent($$result2, "Process", $$Process, { "data-astro-cid-hf4sd4qg": true })} ${renderComponent($$result2, "Bio", $$Bio, { "data-astro-cid-hf4sd4qg": true })} ${renderComponent($$result2, "CTA", $$CTA, { "data-astro-cid-hf4sd4qg": true })} ` })} `;
}, "/Users/anthonycandaele/Projects/webmoov4/website/src/pages/over-ons.astro", void 0);

const $$file = "/Users/anthonycandaele/Projects/webmoov4/website/src/pages/over-ons.astro";
const $$url = "/over-ons";
